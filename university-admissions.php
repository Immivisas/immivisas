...
<head>
    ...
    <title>University Admissions &#8211; IVS Solutions</title>
                       ...
                       <h1>Services</h1>
                        <ul class="breadcrumb-nav list-inline">
							...
							<li><a href="services.php">services</a></li>
                           	<li>Foreign University Admissions</li>
                ...
                <div class="col-lg-9 col-md-12">
                    <article class="blog-post">
                        <div class="post-thumb">
                            <img src="assets/img/university-admission.jpg" alt="">
                        </div>
                        
                        <div class="post-content">
                            <h4 class="post-title">Foreign University Admissions
</h4>
                          <p>IVS Solutions is an expert in getting its student in the top 100 Universities in the world. We understand how important it is for a student to go to a good university in order to succeed in life.</p><br>
<p>University admission process are long and extremely time consuming. There are different intakes in a year and can vary with the choice of course of a student.</p><br>
<p>It is important for a student to send his/her application at the right time in order to secure a seat in the best universities.</p><br>
<p>Our counselors are in constant touch with the top university admissions department through out the year to understand university requirements and update our students with the same.</p>
