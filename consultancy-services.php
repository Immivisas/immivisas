...
<head>
    ...
    <title>Consultancy Services &#8211; IVS Solutions</title>
                ...
                <div class="col-lg-9 col-md-12">
                    <article class="blog-post">
                        <div class="post-thumb">
                            <img src="assets/img/consultancy.jpg" alt="">
                        </div>
                        
                        <div class="post-content">
                            <h4 class="post-title">Consultancy Services
</h4>
                         <p>IVS Solutions is a complete online solutions provider for education, career, visa &amp; foreign investment . We provide education and immigration assistance to over 30 countries across the globe. Using technology as a tool, IVS Solutions endeavors to provide a transparent, user friendly and more accessible service to its clients. We provide necessary services within the realms of relocation and visits to various countries. Our list of clients include well known personalities from India who have also provided there video testimony on our Facebook page.</p><br>
