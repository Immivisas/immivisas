...
">
    ...
    <title>Contact us &#8211; IVS Solutions</title>
...
<body class="gray-bg">
   ...
   <?php include 'top.php';?>
        ...
        <!-- Breadcrumb Area -->
        <section id="breadcrumb-area" style="background-image: url(assets/img/contact-bg.jpg);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="contact-us-info ">
                        ...
                        <ul class="contact-info">
                            <li class="contact-address">
                                ...
                                <p>2003, Agarwal Trinity Tower, Malad West, Mumbai, Maharashtra - 400064, India</p>
                            </li>
                            <li class="contact-email">
                                <p><a href="mailto:immivisas@gmail.com" style="color: #ffc800;" class="__cf_email__" data-cfemail="771a161e1b3714181a0716190e5914181a">immivisas@gmail.com</a>
