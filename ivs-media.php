...
<head>
    ...
    <title> Ivs &#8211 Media &#8211; IVS Solutions - IMMIVISAS</title>
...
<body class="gray-bg">
    ...
    <?php include 'top.php';?>
        ...
        <section id="gallery" class="portfolio-masonary section-padding-top" style="background-color: #f3f3f3 !important;">
        <div class="container">
           <div class="row">
           <div class="col-lg-9">
            
            <div class="row portfolio gallery" id="grid">
			
				<div class="col-lg-4 col-md-6 col-sm-6 col-12" data-groups='["","images", "Show All"]'>
                    <figure>
                        <img src="assets/img/seminar-1.jpg" alt="">
						<figcaption>
                                <a href="assets/img/seminarw-1.jpg" class="gallery-popup mfp-image"><i class="icofont icofont-plus"></i></a>
                        </figcaption>
                    </figure>
                </div>
				<div class="col-lg-4 col-md-6 col-sm-6 col-12" data-groups='["","images", "Show All"]'>
                    <figure>
                        <img src="assets/img/seminar-2.jpg" alt="">
						<figcaption>
                                <a href="assets/img/seminarr-2.jpg" class="gallery-popup mfp-image"><i class="icofont icofont-plus"></i></a>
                        </figcaption>
                    </figure>
                </div>
				<div class="col-lg-4 col-md-6 col-sm-6 col-12" data-groups='["","images", "Show All"]'>
                    <figure>
                        <img src="assets/img/seminar-3.jpg" alt="">
						<figcaption>
                                <a href="assets/img/seminarr-3.jpg" class="gallery-popup mfp-image"><i class="icofont icofont-plus"></i></a>
                        </figcaption>
                    </figure>
                </div>
            </div>
