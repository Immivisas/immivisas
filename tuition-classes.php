...
<head>
    ...
    <title>Tuition Classes &#8211; IVS Solutions</title>
                ...
                <div class="col-lg-9 col-md-12">
                    <article class="blog-post">
                        <div class="post-thumb">
                            <img src="assets/img/tution-classes.jpg" alt="">
                        </div>

                        <div class="post-content" >
                            <h2 class="post-title" style="margin-bottom:0px;">Tuitions for Class 1 to 12.</h2>
                            <h2>One to One Live Online Classes</h2><br>
                            <ul class="rubal-list">
                                <li>One to One teaching format.</li>
                                <li>Teachers with more than 5 years of experience from all over India.</li>
                                <li> All Boards Teaching Available including CBSE, IB, Cambridge & State Board.</li>
                                <li>Teachers are available for all subjects.</li>
                                <li>Flexible Timing as per student/parent convenience.</li>
                                <li>Monthly progress report and discussion with students and parents.</li>
                                <li>Reasonable prices</li>
                                <li>Improved Exam scores and grades</li>
                                <li>Crash Courses available as per request.</li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <ul class="share-icon text-center text-md-center">
                                        <li><a href="https://www.facebook.com/ivssolutions"
                                                class="icofont icofont-social-facebook" target="_blank"></a></li>
                                        <li><a href="https://twitter.com/IVSSolutions"
                                                class="icofont icofont-social-twitter" target="_blank"></a></li>
                                        <li><a href="https://in.linkedin.com/in/ivssolutions"
                                                class="icofont icofont-social-linkedin" target="_blank"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
