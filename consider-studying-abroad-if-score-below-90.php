...
<head>
    ...
    <title>Consider Studying Abroad if Score below 90% &#8211; IVS Solutions</title>
                    ...
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb-nav list-inline">
							...
							<li><a href="blog.php">Blog</a></li>
                           	<li>Consider Studying Abroad if Score below 90%</li>
                ...
                <div class="col-lg-9 col-md-12">
                    <article class="blog-post">
                        ...
                        <ul class="meta-info">
                            ...
                            <li class="comments-quantity"><a href="#"><i class="icofont icofont-ui-chat"></i> (02) Comments</a></li>
                            <li class="posted-by"><i class="icofont icofont-user"></i> By <a href="#">admin</a></li>
                            
                        </ul>
                        <div class="post-content">
                            <h4 class="post-title">Consider Studying Abroad if Score below 90%</h4>
                            <p>If your score in 12th class is below 90% to get admission in a good college in India is difficult due to high cut off. Hence studying in other countries like the USA, Canada, etc. can be a much viable option. Studying abroad provides a good education in a safe environment at a cost as low as 7 Lakhs per year. The students will get to study in a diverse environment with world-class faculty and excellent campus with amazing facilities. These countries also provide part-time & full-time work permit during the study period, which gives students an opportunity to gain valuable international experience.</p>
                            <br>
